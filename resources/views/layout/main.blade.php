    ...
    <div class="container">
        ...
        <div class="nav-scroller py-1 mb-2">
            <nav class="nav d-flex justify-content-between">
                <!-- <a class="p-2 text-muted text-center" href="{{ route('home.index') }}">Home</a> -->
                <a class="p-2 text-muted text-center" href="{{ route('home.images') }}">Images</a>
                <a class="p-2 text-muted text-center" href="{{ route('home.videos') }}">Videos</a>
                <a class="p-2 text-muted text-center" href="{{ route('home.images18') }}">18+ Images</a>
                <a class="p-2 text-muted text-center" href="{{ route('home.18videos') }}">18+ Videos</a>
            </nav>
        </div>
