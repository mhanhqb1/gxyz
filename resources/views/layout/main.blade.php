...
<!--        <div class="jumbotron p-3 p-md-5 text-white rounded" style="background-image: url('{{ $jumbotronImage }}');">
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="adsModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="https://rtyznd.com/i/bfdsrtc/cmsp/1805667/kd" width="100%" height="500px"></iframe>
                </div>
            </div>
        </div>
    </div>
